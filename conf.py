...
GITHUB_SOURCE_BRANCH = 'src' # where your Nikola site source will be deployed. We default to master, but user pages should use src or something else.
GITHUB_DEPLOY_BRANCH = 'master' # where Nikola-generated HTML files will be deployed. It should be "gh-pages" for project pages and master for user pages (user.github.io).
